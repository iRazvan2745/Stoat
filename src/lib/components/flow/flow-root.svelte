...
{#if canvas}
    ...
    >
        ...
        {#if canScrollY}
            <div
                class="bg-outline-variant/50 absolute top-1 right-1 bottom-1 w-1.5 rounded-full opacity-0 transition-opacity group-focus-within:opacity-100 group-hover:opacity-100 group-focus-visible:opacity-100"
            >
                <motion.div
        ...
        {#if canScrollX}
            <div
                class="bg-outline-variant/50 absolute right-1 bottom-1 left-1 h-1.5 rounded-full opacity-0 transition-opacity group-focus-within:opacity-100 group-hover:opacity-100 group-focus-visible:opacity-100"
            >
                <motion.div
