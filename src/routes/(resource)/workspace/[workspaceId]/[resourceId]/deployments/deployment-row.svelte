...
>
    <div class="flex min-w-0 flex-1 items-center gap-3">
        <div
            class="flex size-9 shrink-0 items-center justify-center rounded-md {statusClasses}"
        >
        ...
        <div class="flex min-w-0 flex-1 flex-row gap-2 m:items-center">
            ...
            <div class="flex shrink-0 items-center gap-2">
                <span
                    class="m3-font-label-medium rounded-full px-2.5 py-1 {statusClasses}"
                >
                ...
                {#if duration}
                    <span
                        class="text-on-surface-variant m3-font-label-small min-w-8 text-right tabular-nums"
                    >
                        {duration}
                    </span>
                {/if}
