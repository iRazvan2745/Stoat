...
describe("serviceIconSrc", () => {
    ...
    it("keeps data URIs and wraps raw base64", () => {
        ...
        expect(
            serviceIconSrc("PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciPjwvc3ZnPg=="),
        ).toBe(
...
describe("normalizeServiceIcon", () => {
    ...
    it("rejects unsafe values and oversized icons", () => {
        expect(() => normalizeServiceIcon(`javascript${":"}alert(1)`)).toThrow(
            "Invalid service icon",
        );
        expect(() =>
